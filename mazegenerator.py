#Created by Ahmet Bugra Yasar
#Python
#This program will first generate a maze
#Then will solve that maze
#This was created using the Maze Generation Algorithm from Wikipedia
...
White = (255,255,255) #Numbers inside the paranthesis' represent 3 main colours.
GREEN = (0,255,0) #Easy way to remember them are the Powerpuff Girls' Colours.
BLUE = (0,0,255) #Which are, in order, Red, Green and Blue
YELLOW = (255,255,0)

#initialise Pygame
pygame.init() 
pygame.mixer.init()
screen = pygame.display.set_mode((Width,Height)) #This will generate the screen with the resolutions we've created it with
pygame.display.set_caption("Your Very Own Maze") #This will just name it.
clock = pygame.time.Clock() #This is how different frames will appear and pass.

#Maze blocks and structures
x = 0 #Axis x
y = 0 #Axis Y
w = 20  #Width of a single block
grid = []
visited = []
stack = []
solution = {}

#Now we can build a grid
...
# This is just a way to keep the program running
running = True
while running:
